...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    Relational databases are a form of data storage that saves data to a table, or a collection of rows that store records in columns. Relational databases are basically like spreadsheets+++. SQL is a standardized query language for interacting with relational databases.

- [ ] Why do tables need a `primary key`?
  So that each row on the table can be assigned a unique identifier.

- [ ] What is the name given to a table column that references the primary key on another table.
  Foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  An intermediary table that references both tables.
